...
const uploadDir = isVercel ? '/tmp/uploads/medicines' : path.join(__dirname, '../uploads/medicines');
...
try {
  ...
  console.warn(`Could not create medicine uploads directory: ${err.message}`);
}
